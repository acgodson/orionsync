...
import { useCreateSpace } from "@/hooks/wallet";
...
export default function CreateSpaceForm(prop: { spaceId: string }) {
  ...
  const { createSpace, loadingNewSpace } = useCreateSpace(
    spaceId,
    participants
  );
  ...
  return (
    ...
    >
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader> Create Consensus</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            {loadingNewSpace && <LoadingScreen />}
